...
export default function DashboardHeader({ role = "employer", title }) {
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-border bg-background px-4 py-3 md:px-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <Link
          to={role === "employer" ? "/dashboard/employer/messages" : "/dashboard/seeker/messages"}
          className="relative p-2 rounded-lg text-muted-foreground hover:bg-card hover:text-foreground"
          aria-label="Messages"
        >
